function [complete_rute, indx_decisio] = determine_path_zip(predef_folder, predef_file)
...
%     filter = {'*.zip';'*.rar'};
    ...
    [file_export, path_export, indx_decisio_t] = uiputfile(filter, "Save the file", strcat(predef_folder, filesep, predef_file, '.zip'));
