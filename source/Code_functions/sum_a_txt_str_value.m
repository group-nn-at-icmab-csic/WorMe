function sum_a_txt_str_value(arxiu_text_det, nom_det_funcio)
...
% It also goes together with the function f'obtain_from_txt_string'.
%
% Variables
...
%  arxiu_text_det = "asdf.txt";
% nom_det_funcio = "P1011629_skel_00003_01";
% sum_a_txt_str_value(arxiu_text_det, nom_det_funcio)
%
...
% See also:
% write_text_array, read_text_delimiters, obtain_from_txt_string
