function [total_indx_fin] = wide_indx_BB(total_indx, val_exampl, size_BW)
...
%
% Example:
% tic; total_indx_fin = wide_indx_BB(total_indx', 1, size(BW_final)); toc
% [RGB_to_color_new] = paint_indx_to_RGB(imageArray, total_indx_fin, "red"); %Elapsed time is 0.003674 seconds.
