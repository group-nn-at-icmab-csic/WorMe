...
if ~isempty(app.global_S_textscan_table)
    ...
    if ~isempty(app.imatge_anterior_1)
        ...
        if S_textscan_table.IsCeleg == "no"
            app.Image3.ImageSource = "Apps\app_nova_interfaz_nova\Imatges_utilitat\cross.png";
        else
            app.Image3.ImageSource = "Apps\app_nova_interfaz_nova\Imatges_utilitat\greentick.png";
        end
