...
% Exports data to save for Deep Learning models
            ...
            str_folder_t = strsplit(dir_img_originals, filesep);
            str_folder = str_folder_t{end};
...
%             if ~isequal(dir_main_save_folder, 0)
                ...
                folder_to_save = strjoin(dir_split(1:end-1), filesep);
                ...
                [S_textscan_table] = read_data(fullfile(app.appv_dir_output, "main_data_analysis.txt"), read_type, "$", variable_names);
