function [BW_skel, dades_imatge_row, dades_imatge_manual_corrected] = esqueletonitzacio_josep_optim_2(BW_final, escala_imatge, extendre_skel_opcio, reduce_line, n_pixel_margin)

% Like esqueletonitzacio_josep_optim, but gives both the distance for each
