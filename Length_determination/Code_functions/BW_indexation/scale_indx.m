function [indx_BW_scal] = scale_indx(indx_BWcrop, size_BW, size_BWcrop, proporcio_img)
...
% % Scalar index function (f'scale_indx)
% [indx_BW_scal] = scale_indx(indx_BWobj, size(BW_filt), size(BW_filt_crop), proporcio_img);
