...
[worm_length_distance_manual] = worm_length_manual(BW_skel, n_pixel_margin);

dades_imatge_manual_corrected = worm_length_distance_manual / escala_imatge; % Multiplies by the scale ratio (pixels / unit)



% _Data without manual error correction_

[worm_length_distance_normal] = worm_length(BW_skel);

dades_imatge_row = worm_length_distance_normal / escala_imatge; % Multiplies by the scale ratio (pixels / unit)
