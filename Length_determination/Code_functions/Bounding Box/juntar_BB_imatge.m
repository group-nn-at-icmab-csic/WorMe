function juntar_BB_imatge(carpeta_input, carpeta_BB_BW_color, carpeta_BB_merge_original, array_noms_im)
...
% carpeta_BB_merge_original : folder for combined original and BB color images.
%
% Variables
...
for cada_nom_array = array_noms_im
    ...
    for cada_n_original = 1:llargada_theFiles_original
        ...
        if strcmp(cada_nom_array, nom_im_orig_unic)
            ...
            % Obtain the name of the original image
