function [valor_percentual_imatge] = percentatge_imatge(img_inicial, valor_percentual)
...
%
% Exemple funció:
% [valor_percentual_imatge] = percentatge_imatge(BW_ini_regio, 5);
%
% Variables
% img_inicial : imatge inicial
%
% See also:
% bwareaopen_percentatge
