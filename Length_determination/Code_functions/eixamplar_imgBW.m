function [BW_img_final] = eixamplar_imgBW(BW_img, value_eixmp)
...
%
% % Example:
% [BW_img_final] = eixamplar_imgBW(BW_skel_raw, 2);
...
[indx_BWskel_obj_eixamp] = eixamplar_indx_BB(indx_BWskel_obj, value_eixmp, size_BW_objecte_skel);
